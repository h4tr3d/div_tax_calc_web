...
namespace DividendTaxCalculatorLib.BrokerReportAdapters.Open.MOEX
{
    ...
    [XmlRoot("spot_non_trade_money_operations")]
    public class spot_non_trade_money_operations
    {
        [XmlElement("item")]
        public List<spot_non_trade_money_operation> items { get; set; }
    }

    public class spot_non_trade_money_operation : base_non_trade_money_operation
    {
